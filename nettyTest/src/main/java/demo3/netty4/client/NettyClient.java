...
import demo3.netty4.channel.NettyChannel;
import demo3.netty4.channelHandler.ChannelHandler;
import demo3.netty4.channelHandler.NettyClientHandler;
...
public class NettyClient extends AbstractClient {
    ...
    protected void doOpen() throws Throwable {
        final NettyClientHandler nettyClientHandler = new NettyClientHandler(getUrl(), this.getChannelHandler());
    ...
    @Override
    protected demo3.netty4.channel.Channel getChannel() {
        Channel c = channel;
        if (c == null || !c.isActive())
            return null;
        return NettyChannel.getOrAddChannel(c, getUrl(), this.getChannelHandler());
    }
